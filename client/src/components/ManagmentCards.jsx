        ...
        <div style={{ marginBottom: "100px" }}>
            ...
            {loading ? <Spinner className='loadingSpinner' style={{ top: '300px' }} animation="grow" variant="secondary" /> :
                <motion.div
                    ...
                    transition={{ duration: .8 }}
                >
                    {tokenExpired ? <div className="messageToClient"><h4 style={{ fontSize: '2em' }}>Dear customer,<br /> Your session is expired, you can log in again by <span className="linksText" onClick={() => tokenExpiredHandle()}>clicking here</span></h4></div> : itemsArr.length === 0 ?
