                ...
                <div className='homePageContent'>
                    ...
                    {userInfo?.isBusinessAccount &&
                        <p>
                            ...
                            In the <span className='linksText' onClick={() => navigate('/business')}>Create new card</span> tab, you can create new business cards as you wish.
                        </p>
                    }
                    ...
                    {!userInfo &&
                        <p>
                            ...
                            We invite you to register by clicking <span className='linksText' onClick={() => navigate('/signup')}>here!</span><br />
